...
class MaintProductAdd extends StatefulWidget {
  final Function(String, String, String, String, String) onAddProduct;

  const MaintProductAdd({super.key, required this.onAddProduct});

  @override
  State<MaintProductAdd> createState() => _MaintProductAddState();
}

class _MaintProductAddState extends State<MaintProductAdd> {
  //Nombre P
